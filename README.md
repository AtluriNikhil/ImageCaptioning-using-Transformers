...
```python
model = torch.hub.load('AtluriNikhil/ImageCaptioning-using-Transformers', 'v3', pretrained=True)  # you can choose between v1, v2 and v3
```
...
```
$ git clone https://github.com/AtluriNikhil/ImageCaptioning-using-Transformers.git
```
...
## Training
Tweak the hyperparameters from <a href='https://github.com/AtluriNikhil/ImageCaptioning-using-Transformers/blob/main/configuration.py'>configuration</a> file.
